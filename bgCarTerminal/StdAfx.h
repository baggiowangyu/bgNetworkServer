...
#if defined(_WIN64)
	#pragma comment(lib, "./Lib_64/dhnetsdk.lib")
	#pragma comment(lib, "./Lib_64/dhconfigsdk.lib")
#else
	#pragma comment(lib, "./Lib_32/dhnetsdk.lib")
	#pragma comment(lib, "./Lib_32/dhconfigsdk.lib")
#endif
